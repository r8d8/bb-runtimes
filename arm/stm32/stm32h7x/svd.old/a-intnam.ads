...
--  Interrupt names for STM32H7x MCU
--  Placeholder - should be generated from SVD file
...
package Ada.Interrupts.Names is
   ...
   --  PVD/AVD through EXTI Line detection
   PVD_AVD_Interrupt             : constant Interrupt_ID := 1;
   ...
   --  USB On The Go FS Wakeup through EXTI interrupt
   ...
   DMAMUX1_OVR_Interrupt         : constant Interrupt_ID := 102;

   --  SDMMC2 global interrupt
   SDMMC2_Interrupt              : constant Interrupt_ID := 124;
   ...
   LPUART1_Interrupt             : constant Interrupt_ID := 142;
